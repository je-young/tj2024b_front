...
let 부평구맛집정보 = {
  ...
  data: [
    ...
    {
      소재지:
        '인천광역시 부평구 갈월서로 46, 상가동 지층 1호 (갈산동, 태화아파트)',
      '업 소 명': '샐돈키친',
      업태: '양식',
      연번: 31,
      전화번호: '032-512-5036',
    ...
    {
      소재지:
        '인천광역시 부평구 충선로203번길 12, 2층 (삼산동, 뉴존프라자 201호)',
      '업 소 명': '우프',
      업태: '양식',
      연번: 49,
      전화번호: '032-515-1154',
...
for (let index = 0; index <= 부평구맛집정보.data.length - 1; index++) {
  // index 는 0부터 부평구맛집정보 자료의 마지막 인덱스까지 1씩 증가 반복
  // index 번째의 인구정보 호출
  let info = 부평구맛집정보.data[index];
  console.log(info);
  // 인구정보 자료를 html 로 구성하기
