...
sessionStorage.setItem(
  '할일',
  JSON.stringify({ 할일내용: '밥먹기', 할일상태: true })
); // {"할일내용":"밥먹기","할일상태":true}
let 반환값4 = sessionStorage.getItem('할일');
console.log(반환값4); // '{"할일내용":"밥먹기","할일상태":true}' // 문자열
