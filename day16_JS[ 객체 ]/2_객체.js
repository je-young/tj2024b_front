...
// [2] 객체 정보 확인
console.log(영화정보);
console.log(영화정보.boxOfficeResult); // 자료 결과 정보 :
console.log(영화정보.boxOfficeResult.weeklyBoxOfficeList); // 주간 박스오피스 영화정보 목록
...
// [3] 영화 정보를 html 에 출력하기
// 1. 어디에, document.querySeletor()
...
for (
  let index = 0;
  index <= 영화정보.boxOfficeResult.weeklyBoxOfficeList.length - 1;
  index++
) {
  // index 는 0부터 주간박스오피스의 마지막 인덱스까지 1씩 증가 반복
  // index 번째의 영화 호출
